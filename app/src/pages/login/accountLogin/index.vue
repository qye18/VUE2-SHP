<template>
  <div class="account-login">
    ...
    <div class="bottom-line">
      <ul>
        <li><router-link :to="{name:'qrcodeLogin'}"><img src="../images/ali.png" alt=""/></router-link></li>
        <li><router-link :to="{name:'qrcodeLogin'}"><img src="../images/weixin.png" alt=""/></router-link></li>
        <li><router-link :to="{name:'qrcodeLogin'}"><img src="../images/qq.png" alt=""/></router-link></li>
        <li><router-link :to="{name:'qrcodeLogin'}"><img src="../images/sina.png" alt=""/></router-link></li>
      </ul>
      <span>
...
<style>
  ...
  .account-login form input { height: 33px;}
  ...
  .account-login .bottom-line ul {display: flex;}

  .account-login .bottom-line ul img{margin-right: 10px;}
